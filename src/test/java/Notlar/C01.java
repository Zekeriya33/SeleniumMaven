...
public class C01 {
 /*
    ...
    ElementNotVisibleException: Selenium Web sayfasında görünür olmayan bir elementi bulmaya çalıştığında
     karşılaşılan bir exception türüdür.

    NoAlertPresentException: Olmayan bir uyarı/pop-up şeklindeki diyalog üzerinde işlem yapılmaya çalışıldığında
    karşılaşılır.
